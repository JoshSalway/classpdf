...
const PRIORITY_MAP = {
  ...
  'pdf-to-excel': 0.9,
  'pdf-to-jpg': 0.9,
  'compress-pdf-for-google-classroom': 0.8,
  'compress-pdf-for-canvas': 0.8,
  'combine-worksheets-into-one-pdf': 0.8,
  'merge-pdfs-for-sub-plans': 0.8,
  'split-scanned-test-into-pages': 0.8,
  about: 0.8,
  faq: 0.8,
  contact: 0.7,
  privacy: 0.5,
